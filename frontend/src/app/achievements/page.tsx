            ...
            <div className="flex-1 flex justify-center md:justify-end w-full md:w-auto">
              {user?.isAdmin && (
                <button
                  ...
                  className="bg-black text-white px-4 sm:px-5 md:px-6 py-2.5 sm:py-2.5 md:py-3 rounded-lg font-semibold text-sm sm:text-sm md:text-base hover:bg-gray-800 transition-colors shadow-lg flex items-center gap-2 w-full md:w-auto justify-center whitespace-nowrap"
                >
