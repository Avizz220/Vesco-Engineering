...
const SignUpModal: React.FC<SignUpModalProps> = ({ isOpen, onClose, onSwitchToSignIn }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div
        className="bg-white rounded-2xl shadow-2xl w-full max-w-[95%] sm:max-w-md md:max-w-lg mx-auto p-4 sm:p-6 md:p-8 relative max-h-[95vh] overflow-y-auto overflow-x-hidden scrollbar-hide"
        style={{ borderRadius: '1rem', scrollbarWidth: 'none', msOverflowStyle: 'none' }}
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-3 sm:space-y-4">
          ...
          <button
            type="submit"
            disabled={isLoading}
            className="w-full bg-blue-600 hover:bg-blue-700 text-white font-semibold py-2.5 sm:py-3 rounded-lg transition-colors disabled:opacity-50 mt-4 sm:mt-6 text-sm sm:text-base"
          >
