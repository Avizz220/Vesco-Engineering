          ...
          <div className="flex items-center justify-between">
            ...
            <Link href="/" className="text-3xl font-bold hover:opacity-90 transition-all flex items-center gap-2 pl-0">
              <Image
                ...
                width={420}
                height={140}
                className="h-12 sm:h-14 lg:h-16 w-auto origin-left scale-[1.45] sm:scale-[1.65] lg:scale-[1.8]"
                priority
              />
            </Link>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      <input
                        ...
                        className="w-full rounded-lg border border-gray-200 px-3 py-2 pr-10 text-sm text-gray-900 focus:border-primary-500 focus:ring-2 focus:ring-primary-100 outline-none bg-white"
